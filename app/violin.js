...
const ViolinScreen = () => {
    ...
    <View style={{
      ...
      <Image
              ...
              source={require('../constants/images/UIcons/violin.png')}
              resizeMode='contain'
            />
      </View>
      <View style={{
      ...
      <Image
              ...
              resizeMode='contain'
            />
        <Text style={[styles.clubBlockHeader, {width:'100%', alignSelf: 'center', textAlign: 'center', fontSize: 16, marginTop:0, color: COLORS.white}]}>PROGRAMS</Text>
    </View>
      </View>

    </View>

    <Text style={[styles.screenBio, {fontSize:25}]}>“I am a student passionate about violin competing at the national level with 50+ performances”</Text>
